...
**IoT Security and Privacy Reading List:** From time to time I receive emails asking how to start studying IoT and CPS security and privacy. I and my colleague, Xiaolei Wang, have grouped a collection of papers that we recommend reading for those interested in IoT and CPS security and privacy. If you have any suggestions, please send a [pull request](https://github.com/Beerkay/IoTResearch).
...
- 2018, CoNEXT, [IoTSAN: Fortifying the Safety of IoT Systems](https://arxiv.org/pdf/1810.09551.pdf)
