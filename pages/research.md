...
<img align="left" src="{{ site.base }}/img/IoTResearch/IoTResearch.png" style="border-radius: 15px" hspace="15" width="250"> We have implemented three systems, Soteria, IoTGuard, and Saint to analyze IoT implementations and environments for safety, security and privacy, and a toolset for IoT analysis, IoTBench.
